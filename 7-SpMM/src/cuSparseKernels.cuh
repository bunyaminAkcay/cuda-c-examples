...
void cuSparseSpMMwithCOO(int* h_A_rowIds, int* h_A_colIds, T* h_A_values, T* h_B, T* h_C, T* h_D, size_t m, size_t k, size_t n, size_t nnz, T alpha, T beta){
    ...
    T *d_B, *d_C;
    T *d_A_colIds, *d_A_rowIds, *d_A_values; 
    ...
    cudaMemcpy(d_A_colIds, h_A_colIds, nnz * sizeof(T), cudaMemcpyHostToDevice);
    cudaMemcpy(d_A_rowIds, h_A_rowIds, nnz * sizeof(T), cudaMemcpyHostToDevice);
